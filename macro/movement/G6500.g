...
G6500.1 W{var.workOffset} H{var.boreDiameter} O{var.overTravel} J{move.axes[0].userPosition} K{move.axes[1].userPosition} L{move.axes[2].userPosition - var.probingDepth}
