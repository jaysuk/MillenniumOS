...
G6503.1 W{var.workOffset} H{var.blockWidth} I{var.blockLength} T{var.clearance} O{var.overtravel} J{move.axes[0].userPosition} K{move.axes[1].userPosition} L{move.axes[2].userPosition - var.probingDepth}
