...
G6508.1 W{var.workOffset} Q{var.mode} H{var.xSL} I{var.ySL} N{var.corner} T{var.clearance} O{var.overtravel} J{move.axes[0].userPosition} K{move.axes[1].userPosition} L{move.axes[2].userPosition - var.probingDepth}
